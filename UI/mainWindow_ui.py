...
# Form implementation generated from reading ui file '/home/raulett/store_vol/YandexDisk/Work/ProjectsRepositories/20210416_Rousettus/RousettusTool/UI/mainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logger_view = QtWidgets.QListView(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logger_view.sizePolicy().hasHeightForWidth())
        self.logger_view.setSizePolicy(sizePolicy)
        self.logger_view.setMinimumSize(QtCore.QSize(0, 40))
        self.logger_view.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.logger_view.setBaseSize(QtCore.QSize(0, 0))
        self.logger_view.setFocusPolicy(QtCore.Qt.NoFocus)
        self.logger_view.setResizeMode(QtWidgets.QListView.Adjust)
        self.logger_view.setObjectName("logger_view")
        ...
        self.DBsettingsButton.setCheckable(False)
        self.DBsettingsButton.setEnabled(False)
        ...
        self.actionPlan_routes = QtWidgets.QAction(MainWindow)
        self.actionPlan_routes.setObjectName("actionPlan_routes")
        ...
        self.settings_menu.addAction(self.DBsettingsButton)
        self.settings_menu.addSeparator()
        self.settings_menu.addAction(self.actionSettings)
        self.menuFligft_Planning.addAction(self.actionMake_Profiles)
        self.menuFligft_Planning.addAction(self.actionPlan_routes)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionPlan_routes.setText(_translate("MainWindow", "Plan Routes"))
