...
# Form implementation generated from reading ui file 'D:\YandexDisk\Work\ProjectsRepositories\20210416_Rousettus\RousettusTool\UI\FlightPlanning\RoutePlan.ui'
#
...
class Ui_RoutePlan_form(object):
    def setupUi(self, RoutePlan_form):
        ...
        self.lineEdit_lon.setMinimumSize(QtCore.QSize(100, 25))
        self.lineEdit_lon.setMaximumSize(QtCore.QSize(100, 20))
        font = QtGui.QFont()
        ...
        self.lineEdit_lat.setMinimumSize(QtCore.QSize(100, 25))
        self.lineEdit_lat.setMaximumSize(QtCore.QSize(100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lineEdit_alt.setMinimumSize(QtCore.QSize(100, 25))
        self.lineEdit_alt.setMaximumSize(QtCore.QSize(100, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.gridLayout.addWidget(self.TO_feature_Label, 2, 4, 1, 1)
        self.pushButton_get_to_point = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_get_to_point.setEnabled(False)
        ...
        self.gridLayout.addWidget(self.TO_layer_warning_Label, 0, 4, 1, 1)
    ...
    def retranslateUi(self, RoutePlan_form):
        ...
        self.lineEdit_lon.setText(_translate("RoutePlan_form", "0.0"))
        self.label_2.setText(_translate("RoutePlan_form", "LAT"))
        self.lineEdit_lat.setText(_translate("RoutePlan_form", "0.0"))
        self.label_3.setText(_translate("RoutePlan_form", "ALT"))
        self.lineEdit_alt.setText(_translate("RoutePlan_form", "0.0"))
        ...
        self.pushButton_get_to_point.setToolTip(_translate("RoutePlan_form", "Get existing takeoff point data from layer"))
        self.pushButton_get_to_point.setText(_translate("RoutePlan_form", "<- Get point"))
        self.pushButton.setToolTip(_translate("RoutePlan_form", "store new point into layer, create layer and point if not exist"))
