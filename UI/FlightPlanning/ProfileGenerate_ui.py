...
class Ui_ProfileGenerateWiget(object):
    def setupUi(self, ProfileGenerateWiget):
        ...
        ProfileGenerateWiget.resize(1104, 970)
        ProfileGenerateWiget.setStyleSheet("font-size:15pt")
        ...
        self.groupBox_2.setMinimumSize(QtCore.QSize(910, 340))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 20, 872, 309))
        ...
        self.spinBox_azimuth = QtWidgets.QDoubleSpinBox(self.layoutWidget)
