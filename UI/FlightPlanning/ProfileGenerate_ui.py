...
class Ui_ProfileGenerateWiget(object):
    def setupUi(self, ProfileGenerateWiget):
        ...
        self.spinBox_azimuth = QtWidgets.QSpinBox(self.layoutWidget)
        self.spinBox_azimuth.setMinimumSize(QtCore.QSize(120, 22))
        self.spinBox_azimuth.setMaximumSize(QtCore.QSize(80, 16777215))
        self.spinBox_azimuth.setMaximum(999999)
        self.spinBox_azimuth.setProperty("value", 100)
